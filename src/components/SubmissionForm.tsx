  ...
  return (
    <div className="bg-white border-2 border-border rounded-xl p-6 shadow-sm">
      ...
      {!isComplete && !hasAlreadySubmitted && (
        ...
        >
          <svg
            className="w-5 h-5 text-secondary-text flex-shrink-0 mt-0.5"
            fill="currentColor"
            viewBox="0 0 20 20"
            aria-hidden="true"
          >
      ...
      {isComplete && !hasAlreadySubmitted && (
        <div
          className="flex items-start gap-3 p-4 bg-success-bg/10 rounded-lg mb-6"
          role="status"
        >
          <svg
      ...
      {hasAlreadySubmitted && (
        <div
          className="flex items-start gap-3 p-4 bg-warning-bg/10 rounded-lg mb-6"
          role="alert"
        >
          <svg
